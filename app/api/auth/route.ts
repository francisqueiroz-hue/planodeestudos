...
import {ensureCatalog,seedQuestions} from '../../../lib/bootstrap';
...
export async function GET(r:Request){
 try{return Response.json({user:await currentUser(r)},{headers:noStore})}
...
export async function POST(r:Request){
 ...
 try{
  ...
  if(op==='register'){
   ...
   await ensureCatalog();await seedQuestions(id);
